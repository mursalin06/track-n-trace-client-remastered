...
const Login = () => {
    ...
    return (
        <div className="hero">
            ...
            <div className="card bg-base-100 w-full mx-5 my-6 grid grid-cols-1 md:grid-cols-2 md:w-10/12 shadow-md ">
                ...
                <div className="flex justify-center items-center">
                    <button onClick={handleGoogleSignIn} className="btn w-[250px] md:w-[350px] mx-10 mb-5">Sign in with <span><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
